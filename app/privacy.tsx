...
const SECTIONS = [
  {
    ...
    content:
      'Tether collects only the data you provide directly:\n\n' +
  ...
  },
  {
    ...
    content:
      'Tether uses Anthropic\'s Claude AI to power guided conversations and generate insights.\n\n' +
      ...
      '- Each conversation is processed independently. The AI does not retain information between API calls beyond what Tether explicitly provides as context.\n' +
    ...
    <SafeAreaView style={styles.safe} edges={['top', 'bottom']}>
      ...
      <ScrollView style={{ flex: 1 }} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <Text style={styles.intro}>
          Tether is built on the principle of privacy by design. Your relationship is personal, and your data should be too. This policy explains exactly what we collect, how it is used, and the control you have over it.
        </Text>
